...
JOIN feed_master feemas on fm.feed_id = feemas.feed_id 
WHERE fas.file_name = 'TC030_claims_20240808_part_0001.csv' 
...
AND adf_run_id is not null 
AND is_adf_success = 't'