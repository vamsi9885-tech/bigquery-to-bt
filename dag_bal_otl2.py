...
gear_project_id = config["gear_project_id"]  # gear project id
...
bt_table_name = "gear_cars_logs_catalog_1"  # Bigtable table name
dataset_id = "dw"  # Bigquery Dataset
bq_table_name = "triumph_balance"  # Bigquery table name
pyspark_uri = "gs://prj-d-gbl-gar-epgear/gear_hist_finapi/sample_testing/bq2bt_otl_testing/gear_balance/bal_otl2.py"
json_file = "gear_hist_finapi/sample_testing/bq2bt_otl_mapping/bal_otl2_map.json"
row_key = "cm13"
...
spark_job = {
    "refernce" : {"project_id" : "prj-d-gbl-gar-epgear"},
    "placement":{"cluster_name" : "cluster_name"},
    "spark_job":{
        "main_class" : "com.example.bqtobt.SparkBQToBT",
        "jar_file_uris" :["gs://prj-d-gbl-gar-epgear/gear_hist_finapi/sample_testing/testing_kvchakr/SparkBQToBT-bundled-1.0.jar"],
        "args" :[""]
    }
...
# dag name
DAG_ID = "gear_bal_bt_load_cars_catalog_testing"
# dag
